...
# 1. Update the FILE_PATH variable below to point to your Excel file's location.
#    Use double backslashes (\\) or a raw string (r"path") for Windows paths.
# ==============================================================================
FILE_PATH = r"C:\Path\To\Your\CN Data Jan'26 to May'26.xlsx"
...
# The DataFrame CBM_Data will automatically be imported into Power BI as a Table
CBM_Data = dataset.copy()
